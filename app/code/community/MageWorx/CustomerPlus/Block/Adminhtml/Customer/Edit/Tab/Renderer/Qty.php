...
class MageWorx_CustomerPlus_Block_Adminhtml_Customer_Edit_Tab_Renderer_Qty extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
    	$block = Mage::app()->getLayout()
			->createBlock('core/template')
			->setTemplate('mageworx/customerplus/purchases/grid-renderer-qty.phtml')
