...
class MageWorx_Productplus_Block_Adminhtml_Product_Edit_Tab_Renderer_Customoptions extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
    	$block = Mage::app()->getLayout()
			->createBlock('core/template')
			->setTemplate('mageworx/productplus/purchases/grid-renderer-customoptions.phtml')
	...
	public function renderExport(Varien_Object $_item)
    {
    	...
    	$prefix    = ',';
    	$separator = ':';
    	$helper    = Mage::helper('mageworx_productplus');
