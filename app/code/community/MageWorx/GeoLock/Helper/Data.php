...
{
    const XML_GEOLOCK_ENABLED  = 'mageworx_customers/geolock/enabled';

	const XML_GEOLOCK_RULE_TYPE    = 'mageworx_customers/geolock/rule_type';
	const XML_GEOLOCK_COUNTRIES    = 'mageworx_customers/geolock/countries';
	const XML_GEOLOCK_REDIRECT_URL = 'mageworx_customers/geolock/redirect_url';

	const XML_GEOLOCK_IP_BLACK_LIST = 'mageworx_customers/geolock/ip_black_list';
	const XML_GEOLOCK_IP_WHITE_LIST = 'mageworx_customers/geolock/ip_white_list';
	...
	public function getCountries()
	{
		...
		if ($countriesCode) {
			$countriesCode = Mage::helper('mwgeoip')->prepareCode($countriesCode);
